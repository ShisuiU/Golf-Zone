...
export function VerifyEmail() {
  ...
  if (state.sent) {
    return (
      <p role="status" className="surface p-4 text-[15px] text-body">
  ...
  return (
    <form action={formAction} className="surface p-4">
      ...
      <button
        type="submit"
        disabled={pending}
        className="pressable mt-4 min-h-[44px] cursor-pointer border border-hairline-strong px-5 font-cond text-sm font-semibold uppercase tracking-[0.06em] text-ink disabled:opacity-60"
      >
